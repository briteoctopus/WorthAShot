...
function converter() {
  ...
  else if (inputTypeValue === "teaspoon" && outputTypeValue === "tablespoon") {
  ...
  else if (inputTypeValue === "teaspoon" && outputTypeValue === "centiliter") {
    output.value = Number(input.value)*0.492892;
  }
  else if (inputTypeValue === "teaspoon" && outputTypeValue === "milliliter") {
  ...
  else if (inputTypeValue === "tablespoon" && outputTypeValue === "teaspoon") {
    output.value = Number(input.value)*3;
  }
  ...
  else if (inputTypeValue === "tablespoon" && outputTypeValue === "centiliter") {
    output.value = Number(input.value)*1.47868;
  }
  else if (inputTypeValue === "tablespoon" && outputTypeValue === "milliliter") {
  ...
  else if (inputTypeValue === "centiliter" && outputTypeValue === "teaspoon") {
    output.value = Number(input.value)*2.029;
  }
  else if (inputTypeValue === "centiliter" && outputTypeValue === "tablespoon") {
  ...
  else if (inputTypeValue === "centiliter" && outputTypeValue === "milliliter") {
  ...
  else if (inputTypeValue === "milliliter" && outputTypeValue === "teaspoon") {
    output.value = Number(input.value)/4.929;
  }
  else if (inputTypeValue === "milliliter" && outputTypeValue === "tablespoon") {
    output.value = Number(input.value)/14.787;
  }
  ...
  else if (inputTypeValue === "milliliter" && outputTypeValue === "centiliter") {
    output.value = Number(input.value)/10;
  }
}
